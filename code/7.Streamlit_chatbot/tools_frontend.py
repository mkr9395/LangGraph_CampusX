...
def reset_chat():
    ...
    add_thread(thread_id)  # add the new thread to chat threads
...
if user_input:
    ...
    # this is the new CONFIG will will help the threads to be tracked by langsmith
    CONFIG = {
    ...
    # 4.  # Save assistant message -> Add assistant response to session history
